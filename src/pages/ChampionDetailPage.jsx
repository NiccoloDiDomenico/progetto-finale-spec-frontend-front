...
import { abilityKit, championStats } from "../utils/championStats";
                        ...
                        <div className="space-y-8">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                                    ...
                                    {champion.spells.map((spell, i) => (
                                        <div
                                            key={spell.id}
                                            className="bg-gray-800 p-4 rounded-lg cursor-pointer hover:scale-105 transition"
                                            onClick={() => setSelectedAbility({ ...spell, key: abilityKit[i + 1] })}
                                        >
                                            <img src={spell.image} alt={spell.name} className="mx-auto mb-2" />
                                            <p className="text-lg text-yellow-300 font-bold text-center">{abilityKit[i + 1]}</p>
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4 text-center">
                                    {championStats.map(({ label, stat, perLevel, isPercent }) => (
                                        <div key={stat} className="bg-gray-800 p-4 rounded-lg">
